...
import { pushToFavorites } from '@/utils/books'



const BookPreviewCard = ( {user, title, author, bookImage, description, isbn10, isbn13, publisher, amazonLink} ) => {
  ...
  return (
    <div key={title} className={styles.card}>
      ...
      <button className={styles.button} onClick={() => pushToFavorites(String(user), title, bookImage)}>
            {/* svg */}
